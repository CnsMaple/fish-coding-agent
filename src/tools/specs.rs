        ...
        ToolDef {
            ...
            schema: json!({
                ...
                "properties": {
                    ...
                    "start_line": { "type": "integer", "minimum": 1, "description": "Optional 1-based line to start searching for oldString. If omitted, defaults to the first line. May be provided alone (end_line defaults to the last line)." },
                    "end_line": { "type": "integer", "minimum": 1, "description": "Optional 1-based line to stop searching for oldString, inclusive. If omitted, defaults to the last line. May be provided alone (start_line defaults to the first line)." }
                },
                "required": ["path"],
                "additionalProperties": false
            }),
